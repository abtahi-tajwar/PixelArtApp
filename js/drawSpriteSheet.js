...
finalSpriteSheet.style.height = sheetHeight
finalSpriteSheet.style.width = sheetWidth
...
function drawToSheet(sheet, x, y, i) {
    ...
    if(info.set) {
        console.log(x*pixelSize*pixels + i%32*pixelSize, y*pixelSize*pixels + Math.floor(i/32))
        fc.clearRect(x*pixelSize*pixels + i%32*pixelSize, y*pixelSize*pixels + Math.floor(i/32)*pixelSize, pixelSize, pixelSize);
        fc.fillStyle = info.color
        fc.fillRect(i%32*pixelSize, Math.floor(i/32)*pixelSize, pixelSize, pixelSize);
    } else {
        fc.clearRect(i%32*pixelSize, Math.floor(i/32)*pixelSize, pixelSize, pixelSize);
        fc.fillStyle = 'white'
        fc.fillRect(i%32*pixelSize, Math.floor(i/32)*pixelSize, pixelSize, pixelSize);
    }
}
